        ...
        },
        {
            ...
            Cell:({row})=>{
                return <Group gap='xs' justify='center'>
                    <Button variant='light' color='green' onClick={()=>navigate('/performance/appraisalcycle/myreview', {state:{'appraisal_cycle_id':row.original.appraisal_cycle_id, 'user_login_id':row.original.user_login_id}})}><FaEye/></Button>
