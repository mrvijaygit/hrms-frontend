          ...
          <Grid gutter='sm' align="flex-end">
            ...
            <Grid.Col span={{base:12}}>
              <Group justify='flex-end' gap='sm'>
                <Button leftSection={<FaXmark/>} color="dark.6" type='button' onClick={() => handleClearReset()}>{state?.employee_bank_id == -1 ? 'Clear' : 'Reset'}</Button>
                <Button leftSection={<FaFloppyDisk/>} type='submit'>{state?.employee_bank_id == -1 ? 'Save' : 'Update'}</Button> 
              </Group>
            </Grid.Col>
          </Grid>
        </Box>
